...
<main>
      ...
      <section>
        ...
        <p class="biggerParagraph">
          ...
          passionné ou un amateur curieux, notre site rend les enchères
          accessibles à toutes les générations. Explorez une vaste collection de
          timbres rares et uniques, faites vos offres en quelques clics, et
          profitez d'une expérience fluide adaptée à vos besoins. Plongez dans
          l'univers captivant de la philatélie, sans stress ni complication.
        </p>
      </section>
        ...
        <div class="flex-column flex-column_small-gap">
          <article class="news-card">
            ...
            <div class="news-card-content">
              <p>
                Découvrez l'histoire fascinante du Penny Black, le premier
                timbre postal au monde, mis en vente cette semaine. Une pièce
                incontournable pour les collectionneurs !
              </p>
              <a href="#"
          ...
          <article class="news-card">
            ...
            <div class="news-card-content">
              <p>
                Une collection exceptionnelle de timbres français a été adjugée
                pour un montant record. Retrouvez les détails des enchères et
                les pièces phares de cette collection.
              </p>
              <a href="#"
                ><img src="./assets/img/right-up.webp" alt="icon redirect"
              /></a>
          ...
          <article class="news-card">
            <header class="news-card-header">
              <p>
                <span>Tendances contemporaines</span> &#x2022; Novembre 2024
              </p>
              <h2 class="news-card-header-title">
            ...
            <div class="news-card-content">
              <p>
                Une sélection unique de timbres modernes aux designs audacieux
                est à l'honneur cette semaine. Ces timbres célèbrent des thèmes
                actuels, allant de l'art aux avancées technologiques.
              </p>
              <a href="#"
                ><img src="./assets/img/right-up.webp" alt="icon redirect"
              /></a>
